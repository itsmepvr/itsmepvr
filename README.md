...
- 🤔 Favourite ***`hobby`***:- `Video Games recent flick PUBG`, `debugging others projects`, `travel`.
- 🎶 Music genres I prefer: `Pop`, `folk-pop`, `pop-rock`, `hip-hop` 
- ⚡ Fun fact: I'm a **`freehand artist`** consisting works in `pencil` and `pen` rough sketches 🎨
- 💬 Ask me anything about **`Javascript and Python`** in general 
- 📧 Email id? [pvrreddy155@gmail.com](pvrreddy155@gmail.com)
  <br>
...
<img src="https://github-readme-stats.vercel.app/api?username=itsmepvr&count_private=true&&show_icons=true&title_color=08fdd8&icon_color=bb2acf&text_color=ffffff&bg_color=242424" width="100%"/>
